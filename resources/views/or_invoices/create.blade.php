@extends('layouts.app')
@section('header', 'Create Invoice OR')
@section('content')
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto" x-data="invoiceForm()">
        ...
        <div class="mb-8 flex flex-col md:flex-row gap-4 justify-between md:items-center">
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Create Invoice OR ✨</h1>
            <a href="{{ route('or-invoices.index') }}"
        ...
        <form action="{{ route('or-invoices.store') }}" method="POST" class="space-y-8">
            @csrf
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('invoiceForm', () => ({
                ...
                serviceRates: {
                    ...
                    "Fashion Jewelry": 2500,
                    "Design Services": 4500
                },
                receiver: {
                    client_name: '',
                    organisation_name: '',
                ...
                items: [
                    { service_name: '', custom_name: '', hsn_sac: '7117', qty: '', rate: '', total: '', calculatedMode: 'auto' }
                ],
