...
<div class="mb-6 flex justify-between items-center">
    <div>
        ...
        <p class="text-sm text-slate-500">Create a new customer record.</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 space-y-2">
                    ...
                    <textarea name="registered_address" id="registered_address" rows="3" 
                        class="w-full p-4 rounded-lg border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm @error('registered_address') border-red-500 @enderror">{{ old('registered_address') }}</textarea>
