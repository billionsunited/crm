...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-5xl mx-auto">
    <div class="mb-8 flex justify-between items-center">
        <div>
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Edit Template: {{ $emailTemplate->name }} ✨</h1>
            <p class="text-sm text-slate-500 mt-1">Update your reusable email template.</p>
        </div>
            ...
            <div class="grid grid-cols-1 gap-6">
                <div>
                    ...
                    <input id="name" name="name" 
                        ...
                        type="text" placeholder="e.g. Welcome Email" required value="{{ old('name', $emailTemplate->name) }}" />
                </div>
                ...
                <div>
                    ...
                    <input id="subject" name="subject" 
                        class="w-full rounded-lg border-slate-200 text-sm focus:border-indigo-500 focus:ring-indigo-500 h-[42px] px-3 bg-white" 
                        type="text" placeholder="e.g. Welcome to CRM Billions!" required value="{{ old('subject', $emailTemplate->subject) }}" />
                </div>
